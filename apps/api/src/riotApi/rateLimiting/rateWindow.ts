...
export class RateWindow {
  ...
  /**
   * Adopts Riot's count when it's higher than ours: another process using
   * the same key (the crawler beside the API) spends the same budget. The
   * missing requests are logged as sent now, the safe guess.
   */
